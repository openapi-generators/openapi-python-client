...
) -> Any | ErrorResponse | Literal["Why have a fixed response? I dunno"] | None:
    if response.status_code == 200:
        response_200: Literal["Why have a fixed response? I dunno"] | Any
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | Literal["Why have a fixed response? I dunno"]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | ErrorResponse | Literal['Why have a fixed response? I dunno']
    """
