...
class AModel:
    ...
    A Model for testing all the ways custom objects can be used
        ...
        Properties:
            an_enum_value (AnEnum): For testing Enums in all the ways they can be
    used
            an_allof_enum_with_overridden_default (AnAllOfEnum): None|default:
    AnAllOfEnum.OVERRIDDEN_DEFAULT
            a_camel_date_time (Union[datetime.date, datetime.datetime]): None
            a_date (datetime.date): None
            required_not_nullable (str): None
            one_of_models (Union[Any, FreeFormModel, ModelWithUnionProperty]): None
            ...
            nullable_one_of_models (Union[FreeFormModel, ModelWithUnionProperty,
    None]): None
            not_required_one_of_models (Union[FreeFormModel, ModelWithUnionProperty,
    Unset]): None
            not_required_nullable_one_of_models (Union[FreeFormModel,
    ModelWithUnionProperty, None, Unset, str]): None
            nullable_model (Optional[ModelWithUnionProperty]):
            not_required_model (Union[Unset, ModelWithUnionProperty]):
            not_required_nullable_model (Union[Unset, None,
