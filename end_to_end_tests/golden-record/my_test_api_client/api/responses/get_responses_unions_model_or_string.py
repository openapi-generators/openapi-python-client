...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/responses/unions/model-or-string",
    }

    return _kwargs


def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> str | StreamEvent:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> str | StreamEvent:
            try:
            ...
            return cast(str | StreamEvent, data)
    ...
    return cast(str | StreamEvent, None)


def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[str | StreamEvent]:
    return Response(
