...
class SecurityProperty(Property):
    ...
    template: ClassVar[str] = "security_scheme.py.jinja"
    ...
    def self_import(self) -> str:
        ...
        return f"security.{self.class_info.module_name} import {self.class_info.name}"
...
def build_security_property(
    *,
    ...
    Args:
        data: Data of a single SecurityScheme
