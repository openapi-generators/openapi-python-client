...
class TestGeneratorData:
    def test_from_dict(self, mocker):
        ...
        assert generator_data == GeneratorData(
            ...
            errors=Schemas.build.return_value.errors,
            models=Schemas.build.return_value.models,
        ...
        assert generator_data.models == Schemas.return_value.models
        assert generator_data.errors == Schemas.return_value.errors
...
class TestSchemas:
    def test_build(self, mocker):
        from_data = mocker.patch(f"{MODULE_NAME}.model_from_data")
