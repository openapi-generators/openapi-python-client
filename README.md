...
The Python clients generated by openapi-generator comes some downsides. This tool aims to improve on it by generating clients which:

1. Use all the latest and greatest Python features like type annotations and dataclasses
2. Have better documentation and more obvious usage instructions
